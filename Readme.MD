...
The run_analysis.R file contains two functions.   The first function DownloadData will get the files from and unzip them in a sub-directory off the working directory.    

For purposes of this assignment, I have created a working directory on my computer.   This was done because the download take a while and it was more efficicent to download once and then 
debug the process file.

The processData fucntion will create the final file for this call.  It will aslo create a file with all the variables before they are summarized.   This was used
to validate the correct output.
...
4. finalDataSet.txt - Final data which includes all subject (both training and testing) results and aggragated data.
